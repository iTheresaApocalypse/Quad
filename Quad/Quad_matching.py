...
def matching(result, device):
    validation_info = torch.load("/mnt/petrelfs/zhangchi/LESS-main/grads/deepseekcoder_>512-slimpajama-30000_old/gsm8k-ckpt30000-sgd-folderlambada-266/dim8192/all_orig.pt")
